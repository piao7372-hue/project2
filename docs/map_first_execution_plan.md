...
4. Run NUS Stage 3B with tau/lambda audit first, then formal.
5. Run NUS semantic compatibility audit.
6. Run COCO Stage 3C with tau/lambda audit first, then formal.
7. Run COCO semantic compatibility audit.
8. Stage 3 full cleanup, validation, commit, push.
